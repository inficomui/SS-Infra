                                ...
                                <div className="p-8 space-y-4 max-h-[600px] overflow-y-auto">
                                    {isLoading ? (
                                        ...
                                        <div className="py-20 text-center">
                                            <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">No operators available at the moment.</p>
                                        </div>
                                    ) : (
                                        operators.map((op: any) => (
                                            ...
                                            >
                                                <div className="relative">
                                                    <div className="w-20 h-20 bg-amber-500 rounded-xl flex items-center justify-center text-black font-black text-2xl overflow-hidden">
                                                ...
                                                <div className="flex-1 text-center md:text-left">
                                                    ...
                                                    <p className="text-sm font-black text-zinc-400 uppercase tracking-widest mb-4">{op.district} • {op.taluka}</p>
                                                    <div className="flex items-center justify-center md:justify-start gap-6">
                                                        <div className="flex items-center gap-2 text-xs font-black text-zinc-500">
                                                            <Navigation size={14} className="text-amber-500" /> {op.experience || "Expert"}
                                                        </div>
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-8 py-4 bg-amber-500 hover:bg-amber-600 text-black font-black rounded-xl text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-amber-500/20 active:scale-95 flex items-center gap-3"
                                                    >
