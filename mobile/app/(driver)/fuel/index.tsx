...
export default function DriverFuelLogsScreen() {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            <View style={styles.header}>
                ...
                <TouchableOpacity
                    onPress={() => router.push('/(driver)/fuel/add' as any)}
...
const styles = StyleSheet.create({
    ...
    logCard: { padding: 16, borderRadius: 20, borderWidth: 1, marginBottom: 16 },
