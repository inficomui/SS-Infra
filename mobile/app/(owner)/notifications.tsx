...
// Note: This data would typically come from an API endpoint like /notifications/history
// For now, we are mocking it based on the documented structure.
                ...
                {notifications.length === 0 ? (
                    ...
                    notifications.map((item: any) => (
                        <TouchableOpacity
                            ...
                            onPress={() => router.push({ pathname: '/(owner)/notification-details', params: { id: item.id } } as any)}
                        >
