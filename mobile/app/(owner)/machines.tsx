...
const styles = StyleSheet.create({
    ...
    machineIconBox: { width: 90, height: 90, borderRadius: 16, justifyContent: 'center', alignItems: 'center', borderWidth: 1, overflow: 'hidden', elevation: 1 },
    ...
    machineName: { fontSize: 18, fontWeight: '800', flex: 1, letterSpacing: 0.2 },
    snWrapper: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
    snLabel: { fontSize: 12, fontWeight: '700', textTransform: 'uppercase', opacity: 0.7 },
    machineReg: { fontSize: 14, fontWeight: '800', letterSpacing: 0.5 },
    operatorRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 12, paddingVertical: 4, paddingHorizontal: 10, backgroundColor: 'rgba(0,0,0,0.05)', borderRadius: 8, alignSelf: 'flex-start' },
    operatorName: { fontSize: 13, fontWeight: '700' },
    ...
    miniBtn: { width: 36, height: 36, borderRadius: 18, borderWidth: 1, justifyContent: 'center', alignItems: 'center', elevation: 1 },
