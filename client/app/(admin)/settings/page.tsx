            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-card border border-border p-8 rounded-[16px] shadow-sm transition-all">
                <div className="flex items-center gap-5">
                    <div className="h-14 w-14 bg-zinc-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center border border-zinc-200 dark:border-white/10 shrink-0">
                        <Cpu className="h-7 w-7 text-white dark:text-foreground" strokeWidth={2.5} />
                    </div>
                    <div>
                        <h2 className="text-3xl font-bold text-foreground dark:text-white tracking-tight">System Core Settings</h2>
                        <p className="text-sm font-bold text-foreground dark:text-muted-foreground mt-1 flex items-center gap-2">
                    ...
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={clsx(
                                ...
                                activeTab === tab.id
                                    ? 'bg-primary border-primary text-foreground shadow-xl shadow-primary/20 scale-[1.02] z-10'
                                    : 'bg-card  border-border text-foreground hover:bg-zinc-50 dark:hover:bg-zinc-800'
                            )}
                        >
                            <div className={clsx(
                                "h-11 w-11 flex items-center justify-center rounded-xl shrink-0 transition-all",
                                activeTab === tab.id ? 'bg-black/10 text-foreground' : 'bg-muted dark:bg-white/5 text-foreground group-hover:bg-primary/20 group-hover:text-primary'
                            )}>
                                <tab.icon className="h-5 w-5" strokeWidth={activeTab === tab.id ? 2.5 : 2} />
                            </div>
                            <div className="flex-1 min-w-0">
                                <p className={clsx("font-bold text-xs uppercase tracking-widest", activeTab === tab.id ? 'text-foreground' : 'text-foreground dark:text-muted-foreground')}>
                                    {tab.label}
                                </p>
                                <p className={clsx("text-xs mt-1 font-medium italic opacity-70", activeTab === tab.id ? 'text-foreground/70' : 'text-foreground')}>{tab.description}</p>
                            </div>
                            <ChevronRight className={clsx("h-4 w-4 mt-1 transition-transform", activeTab === tab.id ? 'opacity-100 translate-x-1 text-foreground' : 'opacity-0')} />
                        </button>
                    ))}
                </div>
                ...
                <div className="flex-1 w-full">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="bg-card  border border-border rounded-[16px] shadow-sm overflow-hidden min-h-[600px]"
                        >
                                ...
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="flex flex-col sm:flex-row items-center gap-10">
                                        <div className="relative group">
                                            ...
                                            <div className="h-40 w-40 rounded-[16px] bg-linear-to-br from-zinc-900 to-zinc-800 dark:from-white dark:to-zinc-200 flex items-center justify-center text-5xl font-bold text-white dark:text-foreground border-8 border-card dark:border-zinc-900 shadow-2xl relative z-10 transition-transform group-hover:scale-105 group-hover:rotate-3 overflow-hidden">
                                                {user?.name?.[0]?.toUpperCase() || 'A'}
                                                <div className="absolute inset-x-0 bottom-0 py-2 bg-black/50 backdrop-blur-md text-[10px] font-bold uppercase tracking-widest text-white text-center opacity-0 group-hover:opacity-100 transition-opacity">
                                                    Identity
                                                </div>
                                            </div>
                                            <button className="absolute -bottom-2 -right-2 h-12 w-12 bg-primary text-foreground border-4 border-card dark:border-zinc-900 rounded-2xl flex items-center justify-center shadow-xl z-20 hover:scale-110 active:scale-95 transition-all" onClick={() => toast.success("Module not operational")}>
                                                <Smartphone className="h-5 w-5" strokeWidth={3} />
                                            </button>
                                        </div>
                                        <div className="text-center sm:text-left space-y-3">
                                            <h3 className="text-3xl font-bold text-foreground dark:text-white tracking-tighter">{user?.name}</h3>
                                            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-widest rounded-full border border-emerald-500/20">
                                                <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></div>
                                                System Administrator Mode Active
                                            </div>
                                            <div className="pt-4">
                                                <button className="text-[10px] font-bold uppercase tracking-widest px-6 py-3 bg-muted dark:bg-white/5 hover:bg-zinc-200 dark:hover:bg-white/10 rounded-xl transition-all border border-border dark:text-white" onClick={() => toast.success("Update requested")}>Update Bio-Metric identity</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-border pt-12">
                                        {[
                                            ...
                                            <div key={i} className={clsx("space-y-3", field.highlight && "md:col-span-2")}>
                                                <label className="text-[10px] font-bold text-foreground dark:text-foreground uppercase tracking-[0.2em] flex items-center gap-2">
                                                ...
                                                <div className={clsx(
                                                    ...
                                                    field.highlight 
                                                        ...
                                                        : "bg-muted/30 dark:bg-white/5 border-border text-foreground dark:text-white"
                                                )}>
                                ...
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <h3 className="text-2xl font-bold text-foreground dark:text-white tracking-tight">Security Cryptography</h3>
                                        </div>
                                        <p className="text-sm font-medium text-foreground dark:text-foreground leading-relaxed max-w-xl">
                                    ...
                                    <form onSubmit={handlePasswordChange} className="space-y-8 max-w-lg">
                                        <div className="space-y-6">
                                            {[
                                                ...
                                                <div key={input.id} className="space-y-3">
                                                    <label className="text-[10px] font-bold text-foreground dark:text-foreground uppercase tracking-[0.2em]">{input.label}</label>
                                                    <div className="relative group">
                                                        <Fingerprint className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-foreground group-focus-within:text-primary transition-all group-focus-within:scale-110" />
                                                        <input
                                                            type={input.show ? "text" : "password"}
                                                            required
                                                            value={input.state}
                                                            onChange={(e) => input.setter(e.target.value)}
                                                            className="pl-14 pr-14 w-full py-4 bg-muted/30 dark:bg-white/5 border border-zinc-200/50 dark:border-white/10 rounded-2xl focus:bg-background focus:ring-4 focus:ring-primary/10 focus:border-primary/50 transition-all text-sm font-bold dark:text-white placeholder:text-foreground/30 shadow-inner"
                                                            placeholder="••••••••••••••••"
                                                        />
                                                        <button
                                                            type="button"
                                                            onClick={() => input.toggle(!input.show)}
                                                            className="absolute right-5 top-1/2 -translate-y-1/2 text-foreground hover:text-foreground dark:hover:text-white transition-colors p-2"
                                                        >
                                        ...
                                        <div className="pt-6">
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className="w-full sm:w-auto flex items-center justify-center px-12 py-4 bg-primary text-foreground font-bold rounded-2xl hover:bg-yellow-400 transition-all shadow-xl shadow-primary/20 group disabled:opacity-50"
                                            >
                                ...
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <h3 className="text-2xl font-bold text-foreground dark:text-white tracking-tight">Core Interface Visuals</h3>
                                        </div>
                                        <p className="text-sm font-medium text-foreground dark:text-foreground leading-relaxed max-w-xl">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-between p-10 border border-zinc-200/50 dark:border-white/10 rounded-[16px] bg-blue-100/50 dark:bg-white/5 gap-8 group hover:border-primary/20 transition-all">
                                        <div className="text-center sm:text-left space-y-2">
                                            <p className="font-bold text-xl text-foreground dark:text-white tracking-tight">System Global Theme</p>
                                            <p className="text-sm text-foreground font-medium max-w-xs">Oscillate between High-Entropy Dark and Radiant Light neural modes.</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 opacity-40 grayscale select-none pointer-events-none">
                                        <div className="p-6 rounded-2xl border border-dashed border-zinc-400 dark:border-zinc-700 flex items-center justify-between">
                                            <span className="text-xs font-bold uppercase tracking-widest text-foreground">OLED Black (Labs)</span>
                                            <div className="h-6 w-6 rounded-full bg-zinc-400"></div>
                                        </div>
                                        <div className="p-6 rounded-2xl border border-dashed border-zinc-400 dark:border-zinc-700 flex items-center justify-between">
                                            <span className="text-xs font-bold uppercase tracking-widest text-foreground">Neural Blue (Pending)</span>
                                            <div className="h-6 w-6 rounded-full bg-zinc-400"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <h3 className="text-2xl font-bold text-foreground dark:text-white tracking-tight">Intelligence Feed Nodes</h3>
                                        </div>
                                        <p className="text-sm font-medium text-foreground dark:text-foreground leading-relaxed max-w-xl">
                                    ...
                                    <div className="grid gap-6">
                                        {notificationSettings.map((item) => (
                                            <div
                                                ...
                                                className={clsx(
                                                    "group flex items-center gap-6 p-8 rounded-[16px] border transition-all cursor-pointer relative overflow-hidden active:scale-[0.98]",
                                                    item.checked 
                                                        ? "bg-primary/10 border-primary/30 dark:bg-primary/5 dark:border-primary/20" 
                                                        : "bg-muted/30 dark:bg-white/5 border-border grayscale saturate-50 hover:grayscale-0 hover:saturate-100"
                                                )}
                                            >
                                                <div className={clsx(
                                                    "h-14 w-14 rounded-2xl flex items-center justify-center shrink-0 border transition-all",
                                                    item.checked ? "bg-primary text-foreground border-primary/20 shadow-lg shadow-primary/20 scale-110" : "bg-muted/50 dark:bg-black/20 text-foreground border-zinc-200/50 dark:border-white/10"
                                                )}>
                                                    <Zap className={clsx("h-6 w-6", item.checked ? "text-foreground fill-black" : "text-foreground")} strokeWidth={3} />
                                                </div>
                                                <div className="flex-1">
                                                    <p className={clsx("font-bold text-lg tracking-tight", item.checked ? "text-foreground dark:text-white" : "text-foreground")}>{item.title}</p>
                                                    <p className="text-xs font-medium text-foreground dark:text-foreground mt-1">{item.desc}</p>
                                                </div>
                                                <div className={clsx(
                                ...
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <h3 className="text-2xl font-bold text-foreground dark:text-white tracking-tight">Revenue Network Topology</h3>
                                        </div>
                                        <p className="text-sm font-medium text-foreground dark:text-foreground leading-relaxed max-w-xl">
                                    ...
                                    {isLoadingCommissions ? (
                                        <div className="flex flex-col justify-center items-center h-80 space-y-4">
                                            ...
                                            <p className="text-[10px] font-bold text-foreground uppercase tracking-widest">Querying Commission Node...</p>
                                        </div>
                                    ) : (
                                        <div className="space-y-8">
                                            <div className="bg-muted/30 dark:bg-white/5 border border-border rounded-[16px] overflow-hidden shadow-inner">
                                                <div className="grid grid-cols-12 gap-4 px-8 py-5 border-b border-border bg-blue-100/50 dark:bg-white/5 text-[10px] font-bold uppercase tracking-[0.2em] text-foreground dark:text-foreground opacity-70">
                                                ...
                                                <div className="divide-y divide-zinc-200/50 dark:divide-white/5">
                                                    {commissionConfigs.length === 0 && (
                                                        <div className="p-20 text-center space-y-4">
                                                            <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-muted/50 dark:bg-white/5 border border-border">
                                                                <Layers className="h-7 w-7 text-foreground/30" />
                                                            </div>
                                                            <p className="text-sm font-bold text-foreground italic">Topology nodes not defined in system memory.</p>
                                                        </div>
                                                    )}
                                                    ...
                                                    {commissionConfigs.map((config, idx) => (
                                                        <motion.div 
                                                            ...
                                                            className="grid grid-cols-12 gap-4 px-8 py-6 items-center hover:bg-blue-100/50 dark:hover:bg-white/5 transition-all group"
                                                        >
                                                            <div className="col-span-2 flex justify-center">
                                                                <div className="h-10 w-10 rounded-2xl bg-zinc-900 dark:bg-white flex items-center justify-center text-xs font-bold text-white dark:text-foreground border border-zinc-200 dark:border-white/10 group-hover:rotate-6 transition-transform">
                                                                    {config.level}
                                                                </div>
                                                            </div>
                                                            <div className="col-span-5">
                                                                <div className="relative group/input">
                                                                    <input
                                                                        ...
                                                                        className="w-full pl-6 pr-12 py-3 bg-white dark:bg-zinc-800 border border-zinc-200/50 dark:border-white/10 rounded-2xl text-sm font-bold focus:ring-4 focus:ring-primary/10 focus:border-primary/50 transition-all dark:text-white dark:placeholder:text-zinc-600 shadow-sm"
                                                                        placeholder="0.00"
                                                                        step="0.01"
                                                                    />
                                                            ...
                                                            <div className="col-span-2 flex justify-end">
                                                                <button
                                                                    ...
                                                                    className="p-3 text-foreground hover:text-red-500 hover:bg-red-500/10 rounded-2xl transition-all border border-transparent hover:border-red-500/20"
                                                                    title="Detach Level"
                                                                >
                                            ...
                                            <div className="flex flex-col sm:flex-row justify-between pt-6 gap-4">
                                                <div className="flex gap-3">
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 px-6 py-4 bg-muted dark:bg-white/5 hover:bg-zinc-200 dark:hover:bg-white/10 text-foreground dark:text-white font-bold text-[10px] uppercase tracking-widest rounded-2xl transition-all border border-zinc-200 dark:border-white/10 active:scale-95"
                                                    >
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center justify-center gap-2 px-10 py-4 bg-primary text-foreground font-bold uppercase tracking-widest text-[10px] rounded-2xl hover:bg-yellow-400 transition-all shadow-xl shadow-primary/20 disabled:opacity-50 active:scale-95"
                                                >
                            ...
                            {activeTab === 'general' && (
                                <div className="p-10 lg:p-14 space-y-12">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            <div className="h-10 w-10 bg-zinc-900 dark:bg-zinc-100 rounded-xl flex items-center justify-center text-white dark:text-foreground border border-zinc-200 dark:border-white/10">
                                                <LayoutTemplate className="h-5 w-5" strokeWidth={3} />
                                            </div>
                                            <h3 className="text-2xl font-bold text-foreground dark:text-white tracking-tight">Master System Configs</h3>
                                        </div>
                                        <p className="text-sm font-medium text-foreground dark:text-foreground leading-relaxed max-w-xl">
                                    ...
                                    <div className="space-y-10 max-w-xl">
                                        {[
                                            ...
                                            <div key={field.id} className="space-y-3">
                                                <label className="text-[10px] font-bold text-foreground dark:text-foreground uppercase tracking-[0.2em]">{field.label}</label>
                                                <div className="relative group">
                                                    <field.icon className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-foreground group-focus-within:text-primary transition-all" />
                                                    <input
                                        ...
                                        <div className="p-8 border-2 border-dashed border-zinc-200 dark:border-white/10 rounded-[16px] bg-muted/10 dark:bg-white/5 space-y-6">
                                            <div className="flex items-center justify-between">
                                                <div className="space-y-1">
                                                    <p className="font-bold text-lg text-foreground dark:text-white tracking-tight">System Lockdown Protocol</p>
                                                    <p className="text-[10px] font-bold uppercase text-red-500 tracking-[0.1em] flex items-center gap-1.5 animation-pulse">
                                            ...
                                            <p className="text-xs font-medium text-foreground leading-relaxed italic opacity-60">
                                        ...
                                        <div className="pt-6">
                                            <button
                                                ...
                                                className="w-full sm:w-auto flex items-center justify-center gap-3 px-12 py-4 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-foreground font-bold uppercase tracking-widest text-[10px] rounded-2xl hover:opacity-90 active:scale-95 transition-all shadow-xl shadow-black/10"
                                            >
